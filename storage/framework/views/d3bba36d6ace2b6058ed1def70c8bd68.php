            ...
            <div class="row row-sm">
                    ...
                    <div class="container-fluid">
                        <div class="row row-sm">
                            <div class="card-body mt-2 mb-2">
                                ...
                                <form id="frmLogin" method="POST" action="<?php echo e(route('post-login')); ?>">
                                    <?php echo e(csrf_field()); ?>

                                    <h2 class="text-start mb-2"><?php echo e(trans('cruds.site_title')); ?></h2>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="tab01">
                                                    <div class="form-group text-start otpDiv" style="display:none;">
                                                        <label class="tx-medium"><?php echo e(__('cruds.verification_code')); ?></label>
                                                        <input type="text" name="your_otp" id="your_otp" class="form-control" >
                                                    </div>
                                                    <div class="form-group text-start" >
                                                        <label class="tx-medium"><?php echo e(__('cruds.email')); ?></label>
                                                    ...
                                                    <div class="form-group text-start">
                                                        <label class="tx-medium"><?php echo e(__('cruds.password')); ?></label>
                                                        <div class="input-group">
                                                            <input
                                                                class="form-control border-end-0 <?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>"
                                                    ...
                                                    <button type="submit" id="submit" class="btn btn-primary btn-block"><?php echo e(__('cruds.login')); ?></button>
                                                </div>
                ...
                <div class="col-lg-6 col-xl-6 d-none d-lg-block text-center bg-primary details rounded-end-11">
                    <div class="mt-4 pt-4 p-2 pos-relative">
                        ...
                        ?>
                        <img src="<?php echo e($imgUrl); ?>" class="header-brand-img mb-3 mt-3" style="border-radius:100%;width:100px;" alt="logo">
                        <div class="clearfix"></div>
...
<script>
    function sendOTP() {
        ...
        formUrl = "<?php echo e(route('send-otp')); ?>" ;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nayem/Documents/Bitac/projects/store_management_system/resources/views/auth/login.blade.php ENDPATH**/ ?>