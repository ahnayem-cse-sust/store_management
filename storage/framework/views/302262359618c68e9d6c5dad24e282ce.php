        ...
        <div class="card border custom-card">
            <div class="card-header custom-card-header">
                <h5 class="main-content-label mb-0">
                    <?php echo e(trans('cruds.create')); ?> <?php echo e(trans('cruds.ps')); ?>
            ...
            <div class="card-body">
                <form action="<?php echo e(route("admin.ps.store")); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="hidden" name="update_id" value="<?php echo e(isset($ps)?$ps->id:0); ?>">
                        ...
                        <div class="col-md-3">
                            <div class="form-group <?php echo e($errors->has('ps_code') ? 'has-error' : ''); ?>">
                                <p class="mg-b-2 tx-semibold"><?php echo e(trans('cruds.ps_code')); ?> (<span
                                        class="required">*</span>)</p>
                                <input type="text" id="ps_code" name="ps_code"
                                    data-model="PS" data-prefix="PS"
                                    data-update_id="<?php echo e(isset($ps) ? $ps->id : 0); ?>"
                                    class="form-control unique_code" placeholder="<?php echo e(trans('cruds.ps_code')); ?>"
                                    value="<?php echo e(old('ps_code', isset($ps) ? $ps->ps_code : '')); ?>"
                                    required>
                                <?php if($errors->has('ps_code')): ?>
                                <em class="invalid-feedback">
                                    <?php echo e($errors->first('ps_code')); ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group <?php echo e($errors->has('ps_date') ? 'has-error' : ''); ?>">
                                <p class="mg-b-2 tx-semibold"><?php echo e(trans('cruds.ps_date')); ?> (<span
                                        class="required">*</span>)</p>
                                <input type="text" id="ps_date" name="ps_date"
                                    class="form-control datepicker-date"
                                    placeholder="<?php echo e(trans('cruds.ps_date')); ?>" value="<?php echo e(date('Y-m-d')); ?>"
                                    value="<?php echo e(old('ps_date', isset($ps) ? $ps->ps_date : '')); ?>"
                                    required>
                                <?php if($errors->has('ps_date')): ?>
                                <em class="invalid-feedback">
                                    <?php echo e($errors->first('ps_date')); ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="description" name="description"
                                    class="form-control"
                                    placeholder="<?php echo e(trans('cruds.remarks')); ?>" value="<?php echo e(isset($ps) ? $ps->description : ''); ?>"
                                    value=""
                                    required>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nayem/Documents/projects/store_management/resources/views/admin/ps/create.blade.php ENDPATH**/ ?>