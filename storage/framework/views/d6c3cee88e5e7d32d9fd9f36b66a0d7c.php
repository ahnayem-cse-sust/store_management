...
<head>
    ...
    <meta name="keywords" content="BITAC IMS - <?php echo e(isset($sub_menu)?$sub_menu->en:''); ?>">

    <!-- FAVICON -->
    <link rel="icon" href="/favicon.ico" type="image/x-icon">

    <!-- TITLE -->
    <title> BITAC IMS - <?php echo e(isset($sub_menu)?$sub_menu->en:""); ?><?php echo $__env->yieldContent('title'); ?></title>
...
<body class="<?php echo e($dir); ?> light-theme horizontalmenu dark-menu">

    <input type="hidden" id="hdSaveBtn" value="<?php echo e(trans('cruds.save')); ?>">
    <input type="hidden" id="hdUpdateBtn" value="<?php echo e(trans('cruds.update')); ?>">
    <input type="hidden" id="hdSelect" value="<?php echo e(trans('cruds.select')); ?>">
    <input type="hidden" id="hdRequiredField" value="<?php echo e(trans('cruds.required_field_message')); ?>">
                            ...
                            <div class="d-flex order-lg-2 ms-auto">
                                ...
                                <div class="dropdown main-header-notification d-none">
                                    ...
                                    <a class="nav-link icon text-center" href="javascript:void(0);">
                                        <img class="header-icons" alt src="<?php echo e($flag); ?>">
                                    </a>
                                    <div class="dropdown-menu" style="width:fit-content!important">
                                        ...
                                        <div class="main-notification-list">
                                            <?php $__currentLoopData = config('panel.available_languages'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $langLocale =>
                                            $langName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="media">
                                                <div class="">
                                                    <a href="<?php echo e(url()->current()); ?>?change_language=<?php echo e($langLocale); ?>">
                                                        <img alt="avatar" src="/assets/images/<?php echo e($langLocale); ?>_flag.jpg"
                                ...
                                <div class="dropdown d-flex main-profile-menu mt-3">
                                    <a class="d-flex" href="javascript:void(0);">
                                        <span class="main-img-user">
                                            <img alt="avatar" src="<?php echo e($photo); ?>">
                                        </span>
                                    </a>
                                    <div class="dropdown-menu">
                                        <div class="header-navheading">
                                            <h6 class="main-notification-title"><?php echo e($user->name); ?></h6>
                                            <p class="main-notification-text"><?php echo e($user->role->title); ?></p>
                                        </div>
                    ...
                    <div class="page-header1">
                        <div>
                            <ol class="breadcrumb">
                                <?php
                                if(isset($main_menu)){ ?>
                                <li class="breadcrumb-item"><a href="javascript:;"><?php echo e($main_menu->$lang); ?></a></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <?php echo e(isset($sub_menu)?$sub_menu->$lang:""); ?>
        ...
        <div class="main-footer text-center">
            <div class="container">
                <div class="row row-sm">
                    <div class="col-md-12">
                        <span>Copyright © <?php echo e(date('Y')); ?> <a href="javascript:void(0);">BITAC IMS</a>.
    ...
    <?php echo $__env->make('layouts.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
    $(function(e) {
        window.SWAL("<?php echo e($message); ?>", "<?php echo e($class); ?>");
    })
    </script>
    <?php endif; ?>
...
</html><?php /**PATH /home/nayem/Documents/Bitac/projects/store_management_system/resources/views/layouts/admin.blade.php ENDPATH**/ ?>