...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.create') }} {{ trans('cruds.role') }}
    </div>
    <style>
    .form-check-label {
    ...
    <div class="card-body">
        <form action="{{ route("admin.roles.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                <label for="title">{{ trans('cruds.role') }} (<span class="required">*</span>) </label>
            ...
            @endforeach
            <div>
                <input class="btn ripple btn-success" type="submit" value="{{ trans('cruds.save') }}">
            </div>
        </form>
    </div>
</div>
