        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <span>{{ __('cruds.contact_amount') }} = {{ $passenger->$contact_amount }}/=</span><span>{{ __('cruds.profit_amount') }} = {{ $passenger->$profit_amount }}/=</span>
                    <span>{{ __('cruds.total_receive') }} = {{ $total_received }}/=</span><span>{{ __('cruds.total_dues') }} = {{ $total_dues }}/=</span>
                    </td>
                </tr>
